function app() {
    ...
    const colorsArray = ['D93C51', 'F6EB15', '4893D8', 'A642AD', '4C6BDB', '186887', 'DF3C54', 'ED8EF7', 'F6EB15', 'F98323', 'ED8EF7', '52ADA8', 'E599B7', 'D93C51', '906A31', 'A642AD', '4893D8', '55DC80']
    ...
    function renderList(arrayOfPlayers) {
        ...
        for (let index = arrayOfPlayers.length - 1; index >= 0; index--) {
            ...
            listPlayers.appendChild(newLine).innerHTML = `<p>${arrayOfPlayers[index]}</p>${buttonsOnList}`
        }
    }
