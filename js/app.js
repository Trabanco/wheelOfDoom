function app() {
    ...
    function addPlayerToList(player) {
        buttonsOnList = '<button type="button" class="buttonlist" id="edit">Edit</button><button type="button" class="buttonlist" id="delete">Delete</button>'
        let listPlayers = document.getElementById('orderlist')
        const newLine = document.createElement('div')
        newLine.className = 'boxplay'
